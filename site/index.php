    ...
    <div class="container pt-5 pb-4">
      <div class="row">
        <div class="text-lg-left text-left align-self-left pt-4 col-md-6 py-3" style="">
		  ...
		  <br>
          <a class="btn btn-lg btn-primary" href="/ordereasy/clientedemo/" target="blank"><b>Ver demonstração</b></a>
        </div>
        ...
        <div class="col-lg-4 p-3 col-md-6">
          <div class="card">
            <div class="card-body p-4"> <img class="img-fluid d-block mb-3 mx-auto" src="img/2.png" width="230">
              <p class="lead"><b>Compartilhe o seu qr code ou link nas Redes Sociais.</b></p>
      ...
      <div class="row justify-content-center">
        <div class="col-lg-4 col-md-6 p-4">
          <div class="row">
            ...
            <div class="col-9">
              <p class="lead mb-1"> <b>ZERO taxas</b></p>
              <p class="mb-0" contenteditable="true">Sem taxas sobre as vendas</p>
            </div>
          </div>
        </div>
        <div class="col-lg-4 col-md-6 p-4">
        ...
        <div class="col-lg-4 p-3 col-md-6">
          <div class="card">
            <div class="card-body p-4"> <img class="img-fluid d-block mb-3 mx-auto rounded-circle" src="img/icon2.jpg" width="130">
              ...
              <p class="mb-0">Aumente suas vendas em até 90% enviando o seu catálogo e evitando aplicativos com produtos de terceiros.</p>
            </div>
          </div>
        </div>
        <div class="col-lg-4 p-3 col-md-6">
